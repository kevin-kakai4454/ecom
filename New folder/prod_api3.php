...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // if (isset($data['prod_name'], $data['prod_price'], $data['prod_desc'], $data['prod_size'], $data['prod_image'])) {
    //     echo json_encode(["message" => " move the image."]);
    // } else {
    //     echo json_encode(["message" => "Failed to move the image."]);
    // }
